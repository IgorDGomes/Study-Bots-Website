...
export default function ChangeArrayCodeCorrection() {
    return (
        <ScrollArea className="flex flex-col max-w-[1080px] bg-secondary/80 rounded-xl py-10 sm:px-10" type="auto">
            ...
            <pre className="hover:border-b-2 hover:border-foreground/10 border-2 border-transparent pl-12">name: &apos;**J-Pop**&apos;,</pre>
            <pre className="hover:border-b-2 hover:border-foreground/10 border-2 border-transparent pl-12">value: &apos;*きゃりーぱみゅぱみゅ, 宇多田ヒカル*&apos;,</pre>
            <pre className="hover:border-b-2 hover:border-foreground/10 border-2 border-transparent pl-6">&#125;,</pre>
            <pre className="hover:border-b-2 hover:border-foreground/10 border-2 border-transparent pl-6">&#123;</pre>
            ...
            <pre className="hover:border-b-2 hover:border-foreground/10 border-2 border-transparent pl-12">value: &apos;*RADWIMPS, ONE OK ROCK, サカナクション*&apos;,</pre>
            <pre className="hover:border-b-2 hover:border-foreground/10 border-2 border-transparent pl-6">&#125;,</pre>
            <pre> </pre>
