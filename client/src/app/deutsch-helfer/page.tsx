    ...
    return (
        <div className="max-w-[1200px] mx-auto my-[200px]">
            <div className="grid lg:flex gap-12 text-center sm:text-left items-center justify-items-center w-[70vw] mx-auto my-20 max-w-[1000px]">
                <Image src={deutschHelfer} alt="Deutsch Helfer" className="w-[300px] rounded-xl" />
                <div className="flex flex-col gap-5 max-w-[670px] text-center lg:text-left">
                    ...
                    <p>The Deutsch Helfer discord bot was made to help you improve your german proficiency by providing real-life dialogues, resource recommendations, jokes in german and much more to come...</p>
                </div>
            </div>
